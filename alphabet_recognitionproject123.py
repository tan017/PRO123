...
Xtrain,Xtest,ytrain,ytest=train_test_split(X,y,random_state,train_size=7500,test_size=2500)
...
while(True):
    try:
        ...
        pixel_filter=20
        minpixel=np.percentile(image_bw_resized_inverted,pixel_filter)
